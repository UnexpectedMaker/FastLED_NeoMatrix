...
// #pragma message "If you get matrix corruption, turn off
// FASTLED_ALLOW_INTERRUPTS" #pragma message "in this library, or modify
// WAIT_TIME in platforms/esp/8266/clockless_esp8266.h" #pragma message "(raise
// it from 5 to 20 or up to 50 if needed)" Or if you don't need interrupts, you
// can disable them here #define FASTLED_ALLOW_INTERRUPTS 0
#endif
#include <FastLED.h>
 ...
 * See
 * https://github.com/marcmerlin/FastLED_NeoMatrix/blob/cd739d471bbbe22336f281f1d1988aa7e7572340/FastLED_NeoMatrix.cpp#L92
 */
...
public:
  ...
  FastLED_NeoMatrix(CRGB *, uint16_t matrixW, uint16_t matrixH, uint8_t tX,
                    uint8_t tY,
                    uint8_t matrixType = NEO_MATRIX_TOP + NEO_MATRIX_LEFT +
